<?php
/*
Plugin Name: TS Webfonts for Standard Plan
Version: 2.0.3
Description: このプラグインを利用することで、あなたのサイトにTypeSquareのWebフォントを簡単に設定できます。
Author: Morisawa Inc.
Author URI: https://profiles.wordpress.org/morisawa/
Plugin URI: https://wordpress.org/plugins/ts-webfonts-for-standard-plan/
...
class TypeSquare_ST {
	...
	public function load_scripts() {
		...
		if ( false !== $uid ) {
			wp_register_script( 'typesquare_std', "//typesquare.com/accessor/script/typesquare.js?{$uid}$query", array( 'jquery' ), $version, false );
