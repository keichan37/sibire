...
if ( isset( $this->properties['refuses_datetime'] ) && !empty( $this->properties['refuses_datetime'] ) ) {
	...
	echo '<span style="color: #CC0000;">'.sprintf( __( "It rejects the reception from %s", LOGIN_REBUILDER_DOMAIN ), date_i18n( 'H:i', $this->properties['refuses_datetime']+$gmt_offset*3600 ) ); ?></span>&nbsp;<input type="submit" name="submit" value="<?php esc_attr_e( 'Acceptance resumes', LOGIN_REBUILDER_DOMAIN ); ?>" class="button" />
...
<th><?php _e( 'Status' ); ?></th>
<td>
<input type="radio" name="properties[xmlrpc_enhanced]" id="properties_xmlrpc_enhanced_0" value="<?php _e( self::XMLRPC_ENHANCED_IN_PREPARATION ); ?>" <?php checked( $this->properties['xmlrpc_enhanced'] == self::XMLRPC_ENHANCED_IN_PREPARATION ); ?> /><label for="properties_xmlrpc_enhanced_0">&nbsp;<span><?php _e( 'in preparation', LOGIN_REBUILDER_DOMAIN ); ?></span></label><br />
<input type="radio" name="properties[xmlrpc_enhanced]" id="properties_xmlrpc_enhanced_1" value="<?php _e( self::XMLRPC_ENHANCED_WORKING ); ?>" <?php checked( $this->properties['xmlrpc_enhanced'] == self::XMLRPC_ENHANCED_WORKING ); ?> /><label for="properties_xmlrpc_enhanced_1">&nbsp;<span><?php _e( 'working', LOGIN_REBUILDER_DOMAIN ); ?></span></label><br />
</td>
</tr>
