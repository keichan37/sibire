            ...
            <div class="section schedule">
              <div class="container">
                ...
                <p class="rule">
                  ...
                  ・イベント当日までに説明と接続テストを行います。イベントに参加いただくにはテストに協力いただく必要があります。<br />
                  ◆推奨環境<br />
                  ・イヤホンまたはヘッドホン<br />
                  ◆参加方法<br />
                ...
                <p class="rule qa">
                  ...
                  <span class="a">A.</span>パソコンもしくはスマートフォンやiPad等のタブレット（カメラとマイク機能がついているもの）が必要です。Zoomでの動画接続とともに、ドラフトの指名にWebアプリを利用するため、スマートフォンの併用も推奨します。<br /><br />
                  <span class="q">Q.</span>Zoomアプリをダウンロードする方法を教えてください。<br />
                  <span class="a">A.</span>Zoomの公式サイトからアカウント登録とソフトのインストールを行ってください。<br /><br />
                  Zoomアプリをダウンロードする<br />
                  <a href="https://zoom.us/download" target="_blank" rel="nofollow">https://zoom.us/download</a><br /><br />
                  <span class="q">Q.</span>接続テストを行う方法を教えてください。<br />
                  <span class="a">A.</span>予約完了後に事務局より、接続テスト用のZoomURLを記載したメールを送信します。<br />
                  テスト用のURLでイベントに関する事前説明を行います。<br /><br />
                  <span class="q">Q.</span>自己紹介の投稿方法は？<br />
                  <span class="a">A.</span>予約完了後、事務局からWebアプリLivecanvasの本イベントの投稿用URLを送付します。専用のIDを入力し、自己紹介文を送付いただきます。<br />
                  （接続テストの日に投稿方法を説明します）
                ...
                <table class="timetable timetable2020">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><ul><li>事業所・市町村が参加者を指名！参加者は♡を受け取るか決断<br />（その後、参加者側からのアプローチもできます）</li></ul></td>
                    </tr>
                    <tr>
