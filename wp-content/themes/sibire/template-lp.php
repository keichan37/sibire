    ...
    <div id="lp">
      ...
      <section>
        ...
        <div class="lp-characteristic-wrap lp-characteristic-wrap-right first-child">
          <div class="lp-characteristic-img"><img class="slide-left" src="<?php echo get_template_directory_uri(); ?>/images/template-lp/lp-characteristic-first-image.png" alt=""></div>
        ...
        <div class="lp-characteristic-wrap lp-characteristic-wrap-left second-child">
          <div class="lp-characteristic-img"><img class="slide-right" src="<?php echo get_template_directory_uri(); ?>/images/template-lp/lp-characteristic-second-image.png" alt=""></div>
          <div class="lp-characteristic-inner">
        ...
        <div class="lp-characteristic-wrap lp-characteristic-wrap-right last-child">
          <div class="lp-characteristic-img"><img class="slide-left" src="<?php echo get_template_directory_uri(); ?>/images/template-lp/lp-characteristic-last-image.png" alt=""></div>
          <div class="lp-characteristic-inner">
            <h3>スキマ時間で活動できる </h3>
      ...
      <section>
        <div class="lp-message-wrap">
          <div class="slide-bottom">
            <h3>sibireが目指す世界<br /><img src="<?php echo get_template_directory_uri(); ?>/images/template-lp/lp-offtokyo.png" alt="OFF TOKYO"></h3>
            <p>「東京」という枠にはまらず働く。<br />
