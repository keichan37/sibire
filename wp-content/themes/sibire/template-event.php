  ...
  <?php get_header(); ?>
    <div id="template-event">
      ...
      <div class="section content1" id="content1">
        ...
        <figure>
          <img src="<?php echo get_template_directory_uri(); ?>/images/template-event/avatar-miyazaki.jpg" alt="宮崎謙介"/>
          <figcaption>
            <h3><span class="facilitator">ファシリテーター</span>宮崎謙介<span>氏</span></h3>
            <p>
