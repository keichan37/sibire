      ...
      <div id="corporations" class="container">
        <div class="section">
          ...
          <p>「OFF TOKYO」を加速するためのイベントを開催。<br />
              地方拠点に就業する人員の獲得、企業誘致など、各社・各エリアが求める内容により、イベントの企画を提案し、運営します。</p>
          <?php
            $args = array(
              'paged' => $paged,
              'post_type' => 'event',
        ...
        <div class="section">
          ...
          <div class="topic-summary owl-carousel">
            <a class="single-related" href="/event/49022">
              <img class="single-related-eyecatch" src="<?php echo get_template_directory_uri(); ?>/images/template-corporations/miyazaki.jpg" />
            ...
            <a class="single-related" href="/offtokyo/wakayama-careerfair">
              <img class="single-related-eyecatch" src="<?php echo get_template_directory_uri(); ?>/images/template-corporations/wakayama.jpg" />
              <h5>OFF TOKYO 和歌山キャリアフェア</h5>
              <p>和歌山県の仕事と暮らしを体験できるイベントです。</p>
            </a>
            <a class="single-related" href="/event/55702">
              <img class="single-related-eyecatch" src="<?php echo get_template_directory_uri(); ?>/images/template-corporations/manabi.jpg" />
              <h5>sibire Study Cafeスタート！#１は「ゲストハウス経営留学」</h5>
              <p>＜OFF TOKYO×Manabi-Stay＞3月5日、イベント開催</p>
            </a>
            <a class="single-related" href="/column/50022">
              <img class="single-related-eyecatch" src="<?php echo get_template_directory_uri(); ?>/images/template-corporations/url.jpg" />
